 ...
 */
@Entity
@Table(name = "controllers", catalog = "SKILL_MNG")
public class Controllers implements java.io.Serializable {
	...
	public Controllers(Date insertDatetime) {
		this.insertDatetime = insertDatetime;
	}

	public Controllers(String displayName, Boolean activeFlg, Date insertDatetime, Date updateDatetime) {
